...
if(isset($_SESSION["USUARIO_LOGADO"]) && ($_SESSION["USUARIO_LOGADO"] == 1)) {
    ...
    if (!$conexao_bd->AbrirConexao()) {
        ...
        if(($_REQUEST["Usuario"] != "") && ($_REQUEST["Senha"] != "")) {
            ...
            $conexao_bd->SetSELECT("Codigo_Usuario,Nome_Usuario,Senha_Acesso,Codigo_Hotel","usuarios");
            ...
            if($conexao_bd->ExecSELECT()) {
                ...
                if($NumeroRegistros == 1) {
                    ...
                    $_SESSION["CODIGO_USUARIO"] = $Registros["Codigo_Usuario"];
                    $_SESSION["CODIGO_HOTEL"] = $Registros["Codigo_Hotel"];
                    echo "<h3>Usuário logado com sucesso...</h3>";
                }
                else {
                    $_SESSION["USUARIO_LOGADO"] = 0;
                    $_SESSION["NOME_USUARIO"] = "";
                    $_SESSION["CODIGO_USUARIO"] = 0;
                    $_SESSION["CODIGO_HOTEL"] = 0;
